    ...
    public class ObjectDumper
    {
        ...
        private string DumpElement(object element, bool isTopOfTree = false)
        {
            ...
            else
            {
                ...
                //doesn't work
                MethodInfo AsEnumerable = element.GetType().GetMethod("AsEnumerable");
                if(AsEnumerable != null)
                {
                    element = AsEnumerable.Invoke(element, new object[0]);
                }
                ...
                {
                    Type objectType = element.GetType();
                    if(objectType.FullName.StartsWith("System.Reflection.") || objectType.FullName.Equals("System.RuntimeType"))
                    {
                        return null;
                    }
